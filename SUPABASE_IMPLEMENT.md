...
- [x] **1.1. Supabase Projesinin Başlatılması:**
...
- [x] **1.3. Row Level Security (RLS) Politikalarının Yazılması:**
...
- [x] **1.4. Özel SQL Fonksiyonları (RPC):**
...
- [x] **2.1. API (FastAPI/Gin) Katmanının Temizlenmesi:**
...
- [x] **2.2. Supabase İstemci (Client) Entegrasyonu:**
...
- [x] **2.3. Celery / Periyodik Görevlerin Güncellenmesi:**
...
- [x] **3.1. Supabase Flutter SDK Kurulumu:**
...
- [x] **3.2. API İsteklerinin Değiştirilmesi (REST -> Supabase SDK):**
...
- [x] **3.3. Kimlik Doğrulama (Auth) Taşıması (Varsa):**
  - Auth şimdilik atlandı (tüm veriler public). Supabase Auth altyapısı hazır, ileride eklenebilir.
- [x] **3.4. Supabase Realtime (Canlı Güncelleme) Entegrasyonu:**
...
- [x] **4.1. Ortam Değişkenlerinin (ENV) Güncellenmesi:**
